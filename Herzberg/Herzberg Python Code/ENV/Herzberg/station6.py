...
class Station6(StationMachine):
    ...
    def __init__(self,name,jobs): 
        ...
        self.machine:Machine=Machine("centrifuge",Settings.chemistry_init_time,Settings.centrifuge_run_time,Settings.centrifuge_standby_time)
    ...
    async def initCentrifuge(self):
        if await self.getStatus()== MachineStatus.On:
            ...
            # await self.setRotorPosition(2) 
            # await self.setRotorPosition(1)
