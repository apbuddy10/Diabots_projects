...
class Grid():
    def __init__(self,pose_1,pose_2,pose_3,row,col):
        assert type(pose_1) is dict
        assert type(pose_2) is dict
        assert type(pose_3) is dict
        self.pose_1 = urlib.poseToList(pose_1) 
        self.pose_2 = urlib.poseToList(pose_2) 
        self.pose_3 = urlib.poseToList(pose_3) 
        self.row = row
        self.col = col
    ...
    def get_target_x_y(self,indx):
        pose = urlib.listToPose(self.final_arr[indx-1]) 
        return pose
